		...
		<header className="navbar">
			<div className="container">
				<div className="navbar-inner">
					...
					<nav className="navbar-inner__nav">{/* DESKTOP */}	
						<NavbarLinks links={data.links} />{/* links */}
					</nav>

					<nav className={ toggleMobMenu ? "navbar-inner__nav-mob active" : "navbar-inner__nav-mob" }
  ...
  return (
    <li className="navbar-links__link">
        <div className="navlink-inner">
          ...
          <a href={props.link.link} className="navlink --white">{props.link.text}</a>
        </div>
    </li>
  )
}